...
**https://stripe-partner-demo-production.up.railway.app** (Connect onboarding,
online Checkout with PayNow, and a Terminal POS with running tabs and refunds).
...
Two small bits of feedback: a few of the Drive links in the lab pages weren't
...
Do feel free to share the demo if it's useful. And we'd love to stay close to the
Stripe team here — Monstar Lab has a good footprint in Singapore, so if delivery
partner opportunities come up, we'd be glad to be considered.
